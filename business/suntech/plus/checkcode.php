...
if($enablegd)
{
	...
	{
		imagettftext($im, 12, rand(30, -30), 5, rand(14, 16), $foregroundArr[rand(0,3)], PHP_ROOT.'include/fonts/ALGER.TTF', $string[0]);
		imagettftext($im, 12, rand(50, -50), 20, rand(14, 16), $foregroundArr[rand(0,3)], PHP_ROOT.'include/fonts/ARIALNI.TTF', $string[1]);
		imagettftext($im, 12, rand(50, -50), 35, rand(14, 16), $foregroundArr[rand(0,3)], PHP_ROOT.'include/fonts/ALGER.TTF', $string[2]);
		imagettftext($im, 12, rand(30, -30), 50, rand(14, 16), $foregroundArr[rand(0,3)], PHP_ROOT.'include/fonts/arial.ttf', $string[3]);
	}
	else
	{
