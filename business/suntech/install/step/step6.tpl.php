  ...
  <div class="warp">
    ...
    <div class="nav_hd">
     ...
     <div class="content">
       ...
       <div style="height:30px; background:url(skin/images/buttom.jpg) no-repeat"></div>
       <div class="btnbox">
...
setting['phpsin'] = 'PHPSIN单点登录系统安装成功......';
	...
	$.ajax({
		   ...
		   success: function(msg){
			   if(msg==1) {
				   ...
				   $('#installmessage').append(setting[m_d[n]] + msg + "<img src='skin/images/correct.gif' /><br>");				   
					n++;
					if(n < m_d.length) {
						reloads();
					} else {
