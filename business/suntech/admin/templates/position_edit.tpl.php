...
<table cellpadding="1" align="center" cellspacing="1" class="table_form">
  <caption>添加推荐位</caption>
   ...
   <tr>
     ...
     <Td class="align_l"><input type="text" name="info[name]" value="<?=$info["name"]?>" size="30" require="true" datatype="require" msg="请填写推荐位名称" /></Td>
   </tr>
   
   <tr>
     <th class="align_r"><font color="red">*</font> <STRONG>排序权值</STRONG></th>
     <Td class="align_l"><input type="text" name="info[listorder]" size="5" value="<?=$info["listorder"]?>"require="true" datatype="number" msg="必须为数字" msgid="point"/><span id="point"/></Td>
   </tr>
