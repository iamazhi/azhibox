...
<table cellpadding="1" align="center" cellspacing="1" class="table_form">
  <caption>添加广告位</caption>
    ...
    <td class="align_l"><input name="info[placename]" type="text" size="30" equire="true" datatype="limit" min="1" max="16" msg="广告位名称不能空！"/>  <font color="red">*</font></td>
    </tr>
   <tr >
    ...
    <td class="align_l"><input type="text" name="info[price]" value="" size="8">元/月 </td>
    </tr>
    <tr >
    ...
    <th class="align_r" width="30%"></td>
      <STRONG>多个广告时</STRONG>      <td class="align_l"><input type="radio" name="info[option]" value="1" id="s1_0"checked>全部列出
        <input type="radio" name="info[option]" value="0 " id="s1_1">随机列出一个</td>
    </tr>
    <tr >
    <th class="align_r" width="30%"></td>
      <STRONG>是否启用</STRONG>      
      <td class="align_l"><input type="radio" name="info[passed]" value="1" id="3_0"checked>是
        <input type="radio" name="info[passed]" value="0" id="3_1">否</td>
    </tr>
    <tr >
      <th class="align_r" width="30%"></td>
