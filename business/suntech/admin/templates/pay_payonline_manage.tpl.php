...
<table cellpadding="1" align="center" cellspacing="1" class="table_list">
  ...
  <tr >
    ...
    <td class="align_c"><? if($v["ispay"]==1) {echo "<font color=red>已审核</font>";}else{ ?> <a href="javascript:if(confirm('确定要审核吗？')) location='?file=payonline&action=ispayid&id=<?=$v["id"]?>'">审核</a><? }?></td>
    </tr>
    <?php }?>
    </table>
