...
<?php foreach($tableinfo as $v)
   {
	...
	$strs="<tr>\n
     ...
     <td class=align_c><a href='?file=focus&action=type_edit&catid=\$catid'>修改</a> | <a href='?file=link&action=type_del&catid=\$catid&typeid=\$id'>删除</a> </td>\n
    </tr>\n";
	 $tree->tree($arrays);
	 $dd = $tree->get_tree(114,$strs,$typeid);
	 echo $dd;
	?>
</table>
