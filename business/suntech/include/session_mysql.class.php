...
class session
{
    ...
    function write($id, $data)
	{
		...
		return $this->db->query("REPLACE INTO $this->table (`sessionid`, `userid`, `ip`, `lastvisit`, `groupid`, `module`, `catid`, `contentid`, `data`) VALUES('$id', '$user_id', '".IP."', '".TIME."', '$_groupid', '$mod', '$catid', '$contentid', '".addslashes($data)."')");
    } 
