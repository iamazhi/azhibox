          ...
          <div class='sitemu'>
               ...
               <div id="m_right">
                  <ul class="my_nav" id="top_t">
                    <li class="sec_2">收货地址</li>
                  </ul>
    <form name="myform"action="" method="post">    
      <table cellpadding="0" cellspacing="1" class="table_list">
      <tr >
      <td colspan="2" bgcolor="#e6f1fb" class="align_l">修改收货地址</td>
      </tr>
...
<?php } unset($DATA); ?>
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="into[telephone]" value="<?php echo $is['telephone'];?>"/>格式：010-10000000-801 </td>
                  </tr>
                  <tr>
                    <td class="align_r">* 手机：</td>
                    <td><input type="text" name="into[mobile]" value="<?php echo $is['mobile'];?>"/>格式：13800000000 </td>
                  </tr>
                  <tr>
