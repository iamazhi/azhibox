 ...
 <div class="content" id="top_t">
  <ul id="menu">
          ...
          <div class='sitemu'>
               ...
               <div id="m_right">
                  <ul class="my_nav" id="top_t">
                    <li class="sec_2">订单信息</li>
                  </ul>
                 <form action="" method="post" >
      <table cellpadding="0" cellspacing="1" class="table_list">
      <tr >
      <td bgcolor="#e6f1fb" class="align_c">产品</td>
      ...
      <td bgcolor="#e6f1fb" class="align_c">下单时间</td>
       ...
       <table cellpadding="0" cellspacing="1" class="table_list">
       <tr>
       <td colspan="2"  bgcolor="#e6f1fb" >订单备注</td>
       </tr>
       <tr>
       ...
       <tr>
        <td class="align_c">   <input type="submit" name="confirms" value="确认" />  <input name="" type="reset" /></td>
       </tr>
       </table>    
  </form>
     </div>        
