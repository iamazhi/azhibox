...
<div class="container">
  ...
  <ul id="menu">
      ...
      <tr>
       <td class="align_r"><font color="red">*</font> 卡号：</td>
       <td>
           <input type="text" size="30" name="infos[card]" require='true' datatype='number'  msg='请检查卡号是否输入正确' msgid="card"/> <span id="card"></span>
        </td>
      </tr>
