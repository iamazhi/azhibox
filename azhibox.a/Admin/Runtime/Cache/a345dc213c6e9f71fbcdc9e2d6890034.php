...
<div class="container">
  ...
  <form class="form-horizontal" role="form" method="post" target='__blank'>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type='url' class="form-control" name='url' placeholder="The url of website">
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-2 control-label">Describe</label>
      <div class="col-sm-10">
        <textarea class="form-control" name='desc' placeholder="The describe of website"></textarea>
      </div>
    </div>
