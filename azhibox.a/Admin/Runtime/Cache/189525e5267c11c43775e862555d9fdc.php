    ...
    <div class="panel-body">
      <form class="form-horizontal" method="post">
        <div class="form-group">
          ...
          <div class="col-sm-5"><input type="text" class="form-control" name="title" value="<?php echo ($ramble["title"]); ?>"></div>
        </div>
        <div class="form-group">
          <label class="col-sm-1 control-label">内容</label>
          <div class="col-sm-10"><textarea name='content' rows='15' class='form-control webEditor'><?php echo ($ramble["content"]); ?></textarea></div>
        </div>
        <div class="form-group">
          <label class="col-sm-1 control-label">标签</label>
          <div class="col-sm-5"><input type='text' name='tag' value='<?php echo ($ramble["tag"]); ?>' class='form-control' /></div>
        </div>
        <div class="form-group">
